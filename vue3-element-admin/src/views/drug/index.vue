  ...
  <div class="app-container">
    <div class="search-container">
      <el-form ref="queryFormRef" :model="queryParams" :inline="true">
        ...
        <el-form-item prop="type" label="药品类型">
          <el-input
        ...
        <el-form-item prop="license" label="批准文号">
          <el-input
        ...
        <el-form-item prop="standard_code" label="药品本位码">
          <el-input
            v-model="queryParams.standard_code"
            placeholder="药品本位码"
            clearable
            @keyup.enter="handleQuery"
          />
    ...
    <el-card shadow="never" class="table-container">
      ...
      >
        ...
        <el-table-column label="药品名称" prop="name" min-width="100" />
        <el-table-column label="药品类型" prop="type" />
        <el-table-column label="剂型" prop="dosage" />
        <el-table-column label="规格" prop="specifications" />
        <el-table-column label="批准文号" prop="license" />
        <el-table-column label="药品本位码" prop="standardCode" />
...
// import { RolePageVO, RoleForm, RoleQuery } from "@/api/drug/types";

import { getDrugPage } from "@/api/drug/index";
import { DrugQuery, DrugPageVO } from "@/api/drug/types";
...
const queryParams = reactive<DrugQuery>({});

const drugList = ref<DrugPageVO[]>();
...
function handleQuery() {
  loading.value = true;
  getDrugPage(pageNum.value, pageSize.value, queryParams)
    .then((response) => {
