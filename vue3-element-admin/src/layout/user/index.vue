<template>
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-lg-5 col-md-4 col-sm-6">
            <a class="navbar-brand" href="index.html">
              <img src="@/assets/images/user/main-logo.png" class="logo" />
            </a>
          </div>
          <div class="col-lg-4 col-md-4 d-md-block d-sm-none">
            <ul
              class="contact-list d-flex justify-content-lg-end flex-wrap list-unstyled m-0"
            >
              <li class="pe-5 pe-lg-0 pe-xxl-5 pb-3 pb-lg-0">
                <svg class="location primary-color" width="24" height="24">
                  <use xlink:href="#location"></use></svg
                >123 Arling, Miola, NY
              </li>
              <li class="ps-xl-3">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="btn-book text-end">
              <a
                href="booking.html"
                class="btn btn-medium btn-outline-primary btn-pill text-uppercase"
                >Book Now</a
              >
            </div>
          </div>
        ...
        >
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item ps-4 pe-3 dropdown border-right">
              <a
                class="nav-link text-dark p-0 dropdown-toggle"
              ...
              <ul class="dropdown-menu">
                <li class="py-1">
                  <a href="about.html" class="dropdown-item text-uppercase"
                    >About <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="blog.html" class="dropdown-item text-uppercase"
                    >Blog <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a
                    ...
                    >Blog-Single <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="booking.html" class="dropdown-item text-uppercase"
                    >Booking <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="services.html" class="dropdown-item text-uppercase"
                    >Services <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a
                    ...
                    class="dropdown-item text-uppercase"
                    >Departments <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="gallery.html" class="dropdown-item text-uppercase"
                    >Gallery <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="pricing.html" class="dropdown-item text-uppercase"
                    >Pricing <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="contact.html" class="dropdown-item text-uppercase"
                    >Contact <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="team.html" class="dropdown-item text-uppercase"
                    >Our Team <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="review.html" class="dropdown-item text-uppercase"
                    >Reviews <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
                <li class="py-1">
                  <a href="faq.html" class="dropdown-item text-uppercase"
                    >FAQs <span class="badge bg-secondary">Pro</span></a
                  >
                </li>
              </ul>
            </li>
          ...
          <form class="search-form mb-3 mb-lg-0" role="search">
            <svg
              class="search primary-color position-absolute"
              width="18"
              height="18"
            >
            ...
            <input
              class="form-control border-0 ps-4 position-relative"
              type="search"
              placeholder="Search.."
              aria-label="Search"
            />
  ...
  <section id="intro" class="position-relative overflow-hidden">
    <div class="banner">
      <img
        src="@/assets/images/user/banner-image.jpg"
        alt="banner"
        class="img-fluid"
      />
      <div class="container">
        <div class="banner-content position-absolute padding-large">
          ...
          <a
            href="contact.html"
            class="btn btn-medium btn-primary btn-pill text-uppercase"
            >Contact us</a
          >
        </div>
      </div>
...
<script scoped setup>
import UserHeader from "./Header/index.vue";
</script>
<style scoped>
