...
public class NeoDelete {
    ...
    public static boolean deleteAllNodeAndRel() {
        ...
        try {
            ...
            try (Session session = driver.session()) {
                summary = session.writeTransaction(tx -> tx.run("match(n)-[r]-(m) delete n,r,m")).consume();
            } catch (Exception e) {
                e.printStackTrace();
            }
        } finally {
    ...
    public static boolean deleteAllNode() {
        ...
        try {
            driver = NeoPoolUtil.borrowDriver();
            try (Session session = driver.session()) {
                summary = session.writeTransaction(tx -> tx.run("match(n) delete n")).consume();
            } catch (Exception e) {
                e.printStackTrace();
            }
        } finally {
    ...
    public static boolean deleteAllRelation(String nodeLabel) {
        ...
        try {
            driver = NeoPoolUtil.borrowDriver();
            try (Session session = driver.session()) {
                summary = session.writeTransaction(tx -> tx.run("match (n:" + nodeLabel + ")-[r]-() delete r,n")).consume();
            } catch (Exception e) {
                e.printStackTrace();
            }
        } finally {
    ...
    public static boolean deleteIndex(String nodeLabel, String property) {
        ...
        try {
            driver = NeoPoolUtil.borrowDriver();
            try (Session session = driver.session()) {
                summary = session.writeTransaction(tx -> tx.run("drop index on:" + nodeLabel + "(" + property + ")")).consume();
            } catch (Exception e) {
                e.printStackTrace();
            }
        } finally {
    ...
    public static boolean deleteOnlyIndex(String nodeLabel, String property) {
        ...
        try {
            driver = NeoPoolUtil.borrowDriver();
            try (Session session = driver.session()) {
                summary = session.writeTransaction(tx -> tx.run("drop constraint on (s:" + nodeLabel + ") assert s." + property + " is unique")).consume();
            } catch (Exception e) {
                e.printStackTrace();
            }
        } finally {
