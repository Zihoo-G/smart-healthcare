...
public class NeoUtilService {
    ...
    public static void main(String...args) {
        // node csv path
        String medical_check_path = "/kg_input_data/nodes/check.csv";
        String medical_department_path = "/kg_input_data/nodes/department.csv";
        String medical_disease_path = "/kg_input_data/nodes/disease.csv";
        String medical_drug_path = "/kg_input_data/nodes/drug.csv";
        String medical_food_path = "/kg_input_data/nodes/food.csv";
        String medical_producer_path = "/kg_input_data/nodes/producer.csv";
        String medical_symptom_path = "/kg_input_data/nodes/symptom.csv";
...
//        String medical_symptom_path = NeoUtilService.class.getClassLoader().getResource(PropertiesReader.get("medical_symptom")).getPath().replaceFirst("/", "");
        ...
        // rel csv path
        String medical_recommand_eat_path = "/kg_input_data/rels/medical_recommand_eat.csv";
        String medical_belongs_to_path = "/kg_input_data/rels/medical_belongs_to.csv";
        String medical_common_drug_path = "/kg_input_data/rels/medical_common_drug.csv";
        String medical_do_eat_path = "/kg_input_data/rels/medical_do_eat.csv";
        String medical_drugs_of_path = "/kg_input_data/rels/medical_drugs_of.csv";
        String medical_need_check_path = "/kg_input_data/rels/medical_need_check.csv";
        String medical_no_eat_path = "/kg_input_data/rels/medical_no_eat.csv";
        String medical_recommand_drug_path = "/kg_input_data/rels/medical_recommand_drug.csv";
        String medical_has_symptom_path = "/kg_input_data/rels/medical_has_symptom.csv";
        String medical_acompany_with_path = "/kg_input_data/rels/medical_acompany_with.csv";
        String medical_dept_path = "/kg_input_data/rels/medical_dept_path.csv";
